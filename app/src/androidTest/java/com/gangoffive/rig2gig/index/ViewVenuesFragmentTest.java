...
public class ViewVenuesFragmentTest {
    private ArrayList<HashMap<String, Object>> venueAdvertsData;
    private Activity activity;
    private ListingManager manager;

    @Rule
    public TestRule<ViewVenuesFragment> testRule = new ActivityTestRule(ViewVenuesFragment.class);
    ...
    public void setUp() throws Exception {
        venueAdvertsData = new ArrayList();
    ...
    {
        onView(ViewMatchers.withId(R.id.name)).perform(typeText("test name edit"));
        closeSoftKeyboard();
