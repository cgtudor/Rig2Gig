 ...
 */
public class BandSectionsPagerAdapter extends FragmentPagerAdapter {
    ...
    public BandSectionsPagerAdapter(Context context, FragmentManager fm, int[] tabTitles, int[] fragmentArray) {
        super(fm);
        mContext = context;
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            case 0:
                fragment = new ViewBandsFragment();
                break;
            case 1:
                fragment = new SavedBandsFragment();
                break;
        }
        return fragment;
    }
