 ...
 */
public class VenueSectionsPagerAdapter extends FragmentPagerAdapter {
    ...
    public VenueSectionsPagerAdapter(Context context, FragmentManager fm, int[] tabTitles, int[] fragmentArray) {
        super(fm);
        mContext = context;
