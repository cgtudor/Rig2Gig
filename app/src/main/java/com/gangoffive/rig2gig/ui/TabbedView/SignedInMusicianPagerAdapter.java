 ...
 */
public class SignedInMusicianPagerAdapter extends FragmentPagerAdapter {
    ...
    public SignedInMusicianPagerAdapter(Context context, FragmentManager fm, int[] tabTitles, int[] fragmentArray) {
        super(fm);
        mContext = context;
