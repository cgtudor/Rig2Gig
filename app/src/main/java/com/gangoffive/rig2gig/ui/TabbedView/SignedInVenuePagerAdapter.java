...
import com.gangoffive.rig2gig.account.CreateMusicianFragment;
import com.gangoffive.rig2gig.account.CreateVenueFragment;
 ...
 */
public class SignedInVenuePagerAdapter extends FragmentPagerAdapter {
    ...
    public SignedInVenuePagerAdapter(Context context, FragmentManager fm, int[] tabTitles, int[] fragmentArray) {
        super(fm);
        mContext = context;
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            case 0:
                fragment = new SignedInCredentialFragment();
                break;
            case 1:
