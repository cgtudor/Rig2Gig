...
public class BandRefineSearchActivity extends AppCompatActivity {

    private final int LAUNCH_BAND_POSITION_SELECT = 2709;
    private final int LAUNCH_BAND_GENRE_SELECT = 1414;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_band_refine_search);
        ...
        applyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(positions != null) {
                    returnIntent.putStringArrayListExtra("EXTRA_BAND_POSITIONS", positions);
                }
                if(genres != null) {
                    returnIntent.putStringArrayListExtra("EXTRA_BAND_GENRES", genres);
                }
                setResult(BandRefineSearchActivity.RESULT_OK, returnIntent);
                finish();
            }
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == LAUNCH_BAND_POSITION_SELECT)
        {
        ...
        if (requestCode == LAUNCH_BAND_GENRE_SELECT)
        {
            if (resultCode == RESULT_OK)
            {
    ...
    public void selectPositions()
    {
        ...
        startActivityForResult(intent, LAUNCH_BAND_POSITION_SELECT);
    }
    ...
    public void selectGenres()
    {
        ...
        startActivityForResult(intent, LAUNCH_BAND_GENRE_SELECT);
    }
